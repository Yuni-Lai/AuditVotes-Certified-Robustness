...
parser = argparse.ArgumentParser(description='PyTorch image classification Training with smoothing samples')
parser.add_argument('--dataset', type=str, default="cifar10",choices=DATASETS)
parser.add_argument('--arch', type=str, default="cifar_resnet110", choices=ARCHITECTURES)
parser.add_argument('--outdir', type=str, default="../models/{dataset}/resnet110/noise_{sigma}", help='folder to save model and training log)')
...
def main():
    if args.dataset=="cifar10":
        args.arch=="cifar_resnet110"
    elif args.dataset=="imagenet":
        args.arch == "resnet50"
    args.outdir=args.outdir.format(dataset=args.dataset,sigma=args.noise_sd)
    if args.gpu:
    ...
    for epoch in range(args.epochs):
        ...
        print(f'model saved to {args.outdir}/checkpoint.pth.tar')
